...
Мобильное приложение для поиска вакансий с использованием учебного API, разработанное в рамках дипломного проекта Яндекс Практикум. 
...
*   **Искать вакансии** по обширной базе данных HeadHunter
